...
console.log(
  "os operadores lógicos retornam sempre true ou false, servem para comparar valores"
);
...
if (categoria === "Acima do peso") {
  console.log("Recomendamos moderar no vinho ");
} else if (categoria === "Abaixo do peso") {
  console.log("Um bom vinho e uma tábua de frios podem ajudar a equilibrar!");
} else if (categoria === "Peso ideal") {
  console.log("Excelente! Aproveite uma taça de vinho !");
}
...
if (nome === "admin" && senha === "1234") {
  console.log(" Bem-vindo à Vinharia Guaglini, " + nome + "!");
  console.log("Acesso concedido ao painel da adega virtual.");
  console.log("Explore nossos rótulos exclusivos e promoções especiais.");
} else {
  console.log(" Falha na autenticação.");
  console.log("Usuário ou senha incorretos. Retorne à recepção da vinícola.");
}
...
if (media >= 6) {
  console.log("Vinho Aprovado");
} else {
  console.log("Vinho Reprovado");
}
